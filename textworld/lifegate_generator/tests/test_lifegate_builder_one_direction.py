...
def test_basic_lifegate(game_name = "", life_direction = "east", death_direction = "north", wall_row = 3, 
...
test_basic_lifegate(game_name = 'lifegate_oned_no_drift', life_direction = "north", death_direction = "east", wall_row = 3, 
                        wall_width = 3, wall_col_start = 3)

test_basic_lifegate(game_name = 'lifegate_oned_no_drift', life_direction = "north", death_direction = "east", wall_row = 3, 
                        wall_width = 4, wall_col_start = 2)

test_basic_lifegate(game_name = 'lifegate_oned_no_drift', life_direction = "north", death_direction = "east", wall_row = 3, 
                        wall_width = 4, wall_col_start = 3)

test_basic_lifegate(game_name = 'lifegate_oned_no_drift', life_direction = "north", death_direction = "east", wall_row = 3, 
                        wall_width = 1, wall_col_start = 3)

test_basic_lifegate(game_name = 'lifegate_oned_no_drift', life_direction = "north", death_direction = "east", wall_row = 3, 
                        wall_width = 2, wall_col_start = 5)
